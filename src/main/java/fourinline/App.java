...
import games.connectfour.ConnectFourProblem;
import games.connectfour.ConnectFourState;
...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println ("NOTE: You play as o. You must enter columns (1,2,3,4,5,6 or 7)\n");
        ...
        if (opcion == 1){
            ...
            engine.setMaxDepth(6); // Profundidad maxima para el 4 en línea


            while (!state.end()){
                // Se mostrará el estado inicial
