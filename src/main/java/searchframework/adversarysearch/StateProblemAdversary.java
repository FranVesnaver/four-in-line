...
public interface StateProblemAdversary<S extends StateAdversary> {
    ...
    * @return an integer value, representing the least possible value for the problem.
    * @pre. true.
    * @post. an integer value, representing the least possible value for states, is returned.
    */
    int minValue();
    ...
    * @return an integer value, representing the greatest possible value for the problem. This value must be strictly greater than minValue().
    * @pre. true.
    * @post. an integer value, representing the greatest possible value for states, is returned.
    */
    public int maxValue();
